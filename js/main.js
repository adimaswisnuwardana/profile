$(document).ready(function() {
	$('#myForm').on('submit', function () {
		var valName = $('#nameField').val();
		var valEmail = $('#emailField').val();
		var valBirthdate = $('#birthdateField').val();
		var valGender = $('#genderField').val();
		var valMessage = $('#messageField').val();
		
		$('#sidebar').show();
		$('#valueName').text(valName);
		$('#valueEmail').text(valEmail);
		$('#valueBirthdate').text(valBirthdate);
		$('#valueGender').text(valGender);
		$('#valueMessage').text(valMessage);
	...
	$("#birthdateField").focus(function(){
		this.type='date';
	});
	
	$("#birthdateField").blur(function(){
		if(!this.value){
			this.type='text';
		}
	});
